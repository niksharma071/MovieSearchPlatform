  ...
  return (
    <main className="max-w-xl mx-auto px-4 py-14">
      <div className="bg-surface/90 border border-white/10 rounded-3xl p-10 shadow-xl">
        <h1 className="text-3xl font-display text-white mb-4">Create account</h1>
        <p className="text-sm text-muted mb-6">Sign up to create a new account and save your watchlist.</p>
